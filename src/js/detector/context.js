 ...
 * 
 * Contains a checker, fetcher, dohResolver, and localResolver.
 * Context is useful for sharing the caches of all the objects mentioned: the checker caches check runs, 
 * the fetcher caches similar requests, and the dohResolver caches similar DNS queries (via the fetcher).
 * Through one Context object, the caches can be accessed across multiple checks—or elsewhere
 * 
