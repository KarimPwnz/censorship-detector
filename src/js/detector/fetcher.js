 ...
 * The onBeforeSendHeaders listener matches the id of and removes the X-Censorship-Detector header 
 * and saves the webRequest requestId, in addition to injecting the request headers. If the fetch call is 
